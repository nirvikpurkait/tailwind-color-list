...
describe("return color name for valid color", () => {
  colorAndShadeCombo.forEach((colorAndShade, colorIdx) => {
    colorAndShade.forEach((shade, shadeIdx) => {
      const hexColor = colorList[colorIdx][shadeIdx];
